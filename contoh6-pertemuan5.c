...
int main()
{
	...
	puts("---        Proggramming Examples 6         ---");
	printf("\n\n");
	do
	{
		printf("\n ***** MAIN MENU *****");
		printf("\n 1: Enter the firts polynomial");
		printf("\n 2: Display the firts polynominal");
		printf("\n 3: Enter the second polynomial");
		printf("\n 4: Display the second polynomial");
		printf("\n 5: Add the polynomials");
		printf("\n 6: Display the result");
		printf("\n 7: Substract the polynomials");
		...
		switch(option)
		{
			...
			case 6:start3 =display_poly(start3);
				break;
			case 7:start4 =sub_poly(start1, start2, start3);
				break;
